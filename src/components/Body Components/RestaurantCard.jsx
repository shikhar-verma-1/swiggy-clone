...
const RestaurantCard = ({restaurantData}) =>{
    const{name,avgRating,costForTwo,cuisines,cloudinaryImageId,locality} = restaurantData;
    ...
    return (
        <div className="mx-4">
            <div className="w-[200px] h-[280px] sm:w-[330px] sm:h-[320px] flex flex-col gap-1   hover:scale-95 cursor-pointer">
