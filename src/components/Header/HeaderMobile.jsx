    ...
    return(
        ...
        <header >
            <div className='border border-black px-4 py-4 flex '>
                ...
                <FontAwesomeIcon onClick={navigate_To_UserPageMobile} icon={faCircleUser} className='ml-auto w-8 h-8'/>
            </div>

            <div onClick={navigate_To_SearchPageMobile} className='border border-gray-300 rounded-lg w-[90%] flex items-center mx-auto my-4 px-4 py-4 cursor-pointer hover:border-orange-300'>
